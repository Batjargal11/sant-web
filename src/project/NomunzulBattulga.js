                        ...
                        <div className="row">
                            <div className="col">
                                <div className="page-banner text-center">
                                    <h1>Nomunzul Battulga</h1>
                                    <ul className="page-breadcrumb">
                                        <li><a href="/">Нүүр Хуудас</a></li>
                                        <li><a href="projects">Төгсөгчид</a></li>
                                        <li>Nomunzul Battulga</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-12 section-space--bottom--30">
                            <div className="project-information">
                                ...
                                <ul>
                                    ...
                                    <li><strong>Сургууль:</strong> 550,000 sf</li>
                                    <li><strong>Жил:</strong> 2019</li>
                                    <li><strong>Тэтгэлэг:</strong> $245000000</li>
                                    <li><strong>Мэргэжил:</strong> Comp Science</li>
