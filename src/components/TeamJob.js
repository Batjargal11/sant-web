...
class TeamJob extends Component{
    render(){
        ...
        let DataList = Data.TeamJob.map((val, i)=>{
            return(
                ...
                <div className="container">
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="team-job__title-wrapper">
                            <h2 className="team-job__title">Олимпиад<br /> Тэмцээн</h2>
                        ...
                        <div className="team-job__content-wrapper">
                            <h2 className="team-job__title">Амжилтууд<span><button onClick={null} className="see-more-link see-more-link--color">Цааш үзэх</button></span></h2>
